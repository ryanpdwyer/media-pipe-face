...
class WebcamFacePredictor extends EventTarget {
  constructor(config) {
    super();
  ...
  createDOMElements() {
    ...
    this.label.htmlFor = `showLandmarks-${this.instanceId}`;
    this.label.textContent = 'Show Landmarks';

    this.showLandmarks = document.createElement('input');
    this.showLandmarks.type = 'checkbox';
    this.showLandmarks.id = `showLandmarks-${this.instanceId}`;
    this.showLandmarks.checked = true;
    ...
    this.liveView.appendChild(this.enableWebcamButton);
    this.liveView.appendChild(this.label);
    this.liveView.appendChild(this.showLandmarks);
    this.liveView.appendChild(videoContainer);
  ...
  async predictWebcam() {
    ...
    if (this.lastVideoTime !== this.video.currentTime) {
      this.lastVideoTime = this.video.currentTime;
      this.results = faceLandmarker.detectForVideo(this.video, startTimeMs);
    ...
    if (this.results.faceLandmarks && this.showLandmarks.checked) {
...
export {WebcamPredictor, WebcamFacePredictor};